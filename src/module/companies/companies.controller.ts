...
export class CompaniesController {
  ...
  @HttpCode(201)
  @ApiOperation({ summary: 'Yangi kompaniya qoʻshish (Faqat Admin)' })
  ...
  @ApiOperation({ summary: 'Kompaniya maʻlumotlarini yangilash' })
  update(
  ...
  @ApiOperation({ summary: 'Kompaniyani oʻchirish (Faqat Admin)' })
